...
router.get('/extensions/edit', async (req, res) => {
...
router.get('/extensions/edit/:id', async (req, res) => {
...
router.get('/trunks/create', async (req, res) => {
...
router.get('/trunks/edit', async (req, res) => {
...
router.get('/trunks/edit/:id', async (req, res) => {
...
router.get('/queues/create', async (req, res) => {
...
router.get('/queues/edit', async (req, res) => {
...
router.get('/queues/edit/:id', async (req, res) => {
...
router.get('/edit-manually', async (req, res) => {
